...
#define ASSERT_STRING_EQUAL(a,b)	if(strcmp(a, b) != 0)	{\
					func_is_on_error++;\
					printf("-\tin file '%s' function '%s' at line %d in thread id 0x%x in process %d: '%s' != '%s'\n",\
...
#define ASSERT_ESUP(a,b)	if((a) <= (b))	{\
					func_is_on_error++;\
					printf("-\tin file '%s' function '%s' at line %d in thread id 0x%x in process %d: %d !>= %d\n",\
					__FILE__, __func__, __LINE__, (unsigned int)pthread_self(), getpid(), (int)(a), (int)(b)); \
				}
...
#define ASSERT_TRUE(a)		if(!(a))	{\
					func_is_on_error++;\
					printf("-\tin file '%s' function '%s' at line %d  in thread id 0x%x in process %d: %d is FALSE \n",\
					__FILE__, __func__, __LINE__, (unsigned int)pthread_self(), getpid(), a);\
				}
#define ASSERT_FALSE(a)		if((a))	{\
					func_is_on_error++;\
					printf("-\tin file '%s' function '%s' at line %d  in thread id 0x%x in process %d: %d is TRUE \n",\
					__FILE__, __func__, __LINE__, (unsigned int)pthread_self(), getpid(), a);\
				}
#define ASSERT_NULL(a)		if((a) != NULL)	{\
					func_is_on_error++;\
					printf("-\tin file '%s' function '%s' at line %d  in thread id 0x%x in process %d: %p !-> NULL\n",\
					__FILE__, __func__, __LINE__, (unsigned int)pthread_self(), getpid(), a);\
				}
...
#define EMPTY			printf("-\tin file '%s' function '%s' at line %d  in thread id 0x%x in process %d: TO BE TESTED\n",\
...
#define RETURN			if(strcmp(__func__, "main")!=0)	{\
					if(func_is_on_error == 0) 	{\
						...
						printf("ERROR:  file '%s' function '%s' in thread id 0x%x in process %d: %ld error(s)\n",\
